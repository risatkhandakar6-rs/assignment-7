...
export default function Navigation() {
  ...
  return (
    <div className="max-lg:collapse bg-base-200 mb-15 lg:mb-20  shadow-sm w-full rounded-md px-15">
  ...
  <div className="collapse-title navbar">
    <div className="navbar-start">
      ...
      <h1 className=" text-2xl"><span className='font-bold'>Keen</span><span className='text-[#244D3F] '>Keeper</span></h1>
    </div>
